...
While iterating, `pnpm verify:fast` runs the same gate minus e2e, which is the slow
half. Use it between edits; run the full `pnpm verify` before asking for review.
