...
export default function RegisterPage() {
  ...
  /** Set once sign-up is accepted — swaps the form for the check-your-email notice. */
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (signUpError) {
        ...
        // No session yet: `requireEmailVerification` withholds it until the
        // link is followed. Better Auth also returns this same shape for an
        // address that already exists, so the notice must not claim a new
        // account was created — that would be an enumeration oracle.
